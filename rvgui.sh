...
if [[ ! -d ~/revanced-builder-main ]]; then
	...
	cp -r revanced-builder-main/revanced ~/revanced
	rm -r revanced-builder-main/
	rm main.zip
	wget https://github.com/reisxd/revanced-builder/archive/refs/heads/main.zip
	unzip main.zip
	rm -r ~/revanced-builder-main/revanced/
	cp -r ~/revanced ~/revanced-builder-main/revanced
	rm -r ~/revanced/
